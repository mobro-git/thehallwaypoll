...
results = data %>% select(option, votes, share)
...
```{r}
p1 <- results$share[results$option == "Cheez-It"]
...
```{r}
#| label: fig-waffle
#| fig-cap: "Waffle chart: one square per vote."
#| fig-width: 6
#| fig-height: 4
waffle_question(data, "cheese snacks", cols = 6)
```
